...
#include <jni.h>
/* Header for class de_bitkings_jbrotli_BrotliDeCompressor */

#ifndef _Included_de_bitkings_jbrotli_BrotliDeCompressor
#define _Included_de_bitkings_jbrotli_BrotliDeCompressor
#ifdef __cplusplus
extern "C" {
#endif
/*
 ...
 */
JNIEXPORT jint JNICALL Java_de_bitkings_jbrotli_BrotliDeCompressor_deCompressByteBuffer
